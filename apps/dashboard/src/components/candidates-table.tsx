...
export function CandidatesTable() {
  ...
  const effectiveBulkNextStatus =
    commonValidTargets.includes(bulkNextStatus)
      ? bulkNextStatus
      : commonValidTargets[0] ?? "";
    ...
    <div>
      ...
      <div className="flex flex-wrap items-center gap-3 border-b border-neutral-800 bg-neutral-900/50 px-6 py-3">
        ...
        <div className="flex items-center gap-2 border-l border-neutral-700 pl-3">
          <select
            value={effectiveBulkNextStatus}
            onChange={(e) =>
              setBulkNextStatus(e.target.value)
            }
