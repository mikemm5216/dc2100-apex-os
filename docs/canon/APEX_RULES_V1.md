...
related_documents:
  ...
  - CANON.md (existing world canon — APEX levels described in section 5)
...
- Evidence 缺失的報名進入 RESERVE 而非直接 QUALIFIED，待補件後重新審核。
...
- **公開挑戰**：必須公開挑戰一名現任 QUALIFIED 資格保有者並取勝。

Comeback 流程：`COMEBACK_PENDING`（代價已提出，尚未完成）→ 代價完成並經 Gate 7 審核 →
`COMEBACK_GRANTED`。代價未完成前，Driver/Team 不得參加更高層級賽事。
